...
public class FizzBuzzTest {
    ...
    @Test
    void should_return_BuzzWhizz_when_count_off_given_multiple_of_5_and_7() {
        //given
        FizzBuzz fizzBuzz = new FizzBuzz();
    ...
    @Test
    void should_return_FizzBuzz_when_count_off_given_multiple_of_3_and_5() {
        //given
        FizzBuzz fizzBuzz = new FizzBuzz();
    ...
    @Test
    void should_return_FizzWhizz_when_count_off_given_multiple_of_3_and_7() {
        //given
        FizzBuzz fizzBuzz = new FizzBuzz();
    ...
    @Test
    void should_return_FizzBuzzWhizz_when_count_off_given_multiple_of_3_5_and_7() {
        //given
        FizzBuzz fizzBuzz = new FizzBuzz();
